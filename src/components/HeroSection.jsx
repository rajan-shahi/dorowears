      ...
      >
        {items.map((item, index) => (
          <SwiperSlide>
            ...
            >
              <img className=" md:h-full h-60 relative object-cover" src={item.img} alt="" />
              <div className=" md:w-5/12 absolute  md:mr-96 flex flex-col gap-4">
                <span
                  data-aos="fade-up"
                  data-aos-duration="1500"
                  className=" md:text-4xl  text-gray-700 font-semibold tracking-widest"
                >
                  {item.name}
                </span>
                <span
                  ...
                  className=" md:flex hidden tracking-widest text-xl text-gray-600"
                >
                  {item.desc}
                </span>
                <button
                  ...
                  className=" flex  hover:bg-primary-300 duration-500  bg-primary-350 w-max md:px-10 md:py-2 py-1 px-5 md:text-md text-sm text-gray-100"
                >
                  {item.button}
                </button>
              </div>
